...
class getDataAPI {
  static String username = 'khoinguyen3923';
  ...
  static String fanFeed = 'fan-status';
  static String HumidFeed = 'humid';
  static String gasAlarmFeed = 'smart-home-gas-alarm';
  static String ledFeed = 'light-status';
  static String lightFeed = 'light';
  ...
  static Future<bool> updateHumidData(String value) async {
    http.Response response = await http.post(
      Uri.parse('$mainURL$username/feeds/$HumidFeed/data'),
      headers: <String, String>{
        'X-AIO-Key': aioKey!,
        'Content-Type': 'application/json',
      },
