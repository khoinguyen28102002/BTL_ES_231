                                                    ...
                                                    if (widget.info_hour ==
                                                      ...
                                                      a *= HomeController
                                                          .energy_fan;
                                                            ...
                                                            .info_hour ==
                                                        'Temp') {
                                                      // a = giá trị nhiệt độ lớn nhất trước khi mở biểu đồ này
                                                      a *= HomeController
                                                          .energy_fan;
                                                    } else if (widget
                                                            .info_hour ==
                                                        'Humid') {
                                                      // a = giá trị độ ẩm lớn nhất trước khi mở biểu đồ này
                                                      a *= HomeController
                                                          .energy_fan;
                                                    } else {
                                                      // a = giá trị ánh sáng thấp nhất trước khi mở biểu đồ này
                                                      a *= HomeController
                                                          .energy_fan;
                                                    }
                                                    consume_energy[j] += a;
                              ...
                              children: [
                                ...
                                FutureBuilder(
                                  ...
                                  builder: (context,
                                    ...
                                    if (widget.info_hour == 'Led' ||
                                        widget.info_hour == 'Fan') {
                                      num sum = 0;
                                      String s = "Waiting";
                                      if (snapshot.connectionState ==
                                          ConnectionState.done) {
                                      ...
                                      String s = "Waiting";
                                      // Lấy dữ liệu lớn nhất của nhiệt độ hoặc độ ẩm hoặc ánh sáng tại ánh sáng tại đây
